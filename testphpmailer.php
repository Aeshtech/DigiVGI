...
try {
    ...
    $mail->addAddress('ashishpandit5376@gmail.com', 'Recipient');     // Add a recipient
    ...
    $mail->Subject = 'Welcome to DigiVgi';
    $mail->Body    = 'CDP DigiVgi (JAI SHREE KRISHNA) <a href="http://localhost/DigiVgi/password_recovery.php">Click Here</a>';
